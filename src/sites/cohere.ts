/**
 * Cohere (coral.cohere.com, dashboard.cohere.com) site adapter for Obfusca.
 *
 * DOM notes (as of 2025):
 * - Coral is Cohere's chat interface for their Command models
 * - Dashboard includes a playground for testing
 * - Both use modern React-based UIs
 * - Input may be a textarea or contenteditable div with role="textbox"
 */

import type { SiteConfig } from './types';

const SITE_NAME = 'Cohere';
...
/**
 * Cohere site configuration.
 */
export const cohereConfig: SiteConfig = {
  name: SITE_NAME,
