...
const CONTEXT_PATTERNS: ContextPattern[] = [
  {
    ...
    displayName: 'Income/Salary Information',
  ...
  },
  {
    ...
    contextKeywords: [
      ...
      'director', 'manager', 'president', 'chairman', 'founder',
      'co-founder', 'partner', 'principal', 'attorney', 'counsel',
      'officer', 'executive', 'supervisor', 'coordinator', 'analyst',
      'engineer', 'developer', 'architect', 'consultant', 'specialist',
      'husband', 'wife', 'son', 'daughter', 'father', 'mother',
      'brother', 'sister', 'friend', 'colleague', 'neighbor',
      'signed by', 'approved by', 'submitted by', 'reviewed by',
      'authored by', 'assigned to', 'reported by', 'cc:', 'attn:',
    ],
    maxDistance: 150,
    type: 'person_name' as DetectionType,
    displayName: 'Full Legal Name',
